...
//! pairs through the full axum router. Expected responses are GENERATED by
//! real PHP (php:8-cli Docker image, /u forced, PREG_UNMATCHED_AS_NULL) via
//! scripts/gen-fixtures.php — differential testing against the PHP contract,
//! not hand-authored assumptions.
...
fn test_app() -> axum::Router {
    build_router(Arc::new(AppState::new("10.47 test".into())))
}
